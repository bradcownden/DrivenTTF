...
In many previous works, the dynamics of scalar fields have been studied using exclusively normalizable functions. To construct a solution of purely normalizable modes, we require that all $C^-_I = 0$, i.e.,~the frequencies are integers given by $\omega_I = \omega_i = 2i + \Delta^+$ with $i \in \mathbb{Z}^+$. Upon simplification, 
\begin{align}
\label{normal basis}
