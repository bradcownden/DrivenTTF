...
\end{align}
Finally, there are extra contributions of the form \eqref{gen nn} that are present for all choices of $n$ or $m^2$ within the bounds described when
\begin{align}
...
%
& \quad + \!\!\!\! \sum_{\oone + \otwo = 2n} \!\!\!\! \overline{R}^{(1)}_{(\ell)\ell} \, \bar A_1^2 \, a_\ell \cos\left( \theta_{(\ell)} + \theta_1 - \theta_1 \right) + \!\!\!\! \sum_{\oone + \otwo = 2n} \!\!\!\! \overline{R}^{(2)}_{(\ell)\ell} \, \bar A_2^2 \, a_\ell \cos\left( \theta_{(\ell)} + \theta_2 - \theta_2 \right) \nonumber \\
%
...
\end{align}
Where $\overline{R}^{(2)}_{i\ell}$ and $\overline{T}^{(2)}_{\ell}$ follow from \eqref{R1} and \eqref{T1} by replacing $\oone \to \otwo$.
...
%
& \qquad \qquad + \sum_\beta \overline{R}^{(1)}_{\beta \ell} \, a_\ell \bar A_\beta^2  \cos \left(\theta_\ell + \theta_\beta - \theta_\beta \right)  \, ,
\end{align}
where 
\begin{align}
