...
\begin{align}
	\label{inner prod}
	\langle f(x), g(x) \rangle = \int^{\pi/2}_0 dx \, \mu(x) f(x)^\dagger g(x) \, .
\end{align}
...
The AdS/CFT dictionary relates the leading coefficient of the normalizable modes of the scalar field at the boundary to the expectation value of an operator $\langle \mc O_0 \rangle$ there \cite{hep-th/9808017}.
The interpretation of the driving term through the AdS/CFT dictionary is the addition of a time-dependent part of the boundary Hamiltonian. To illustrate this, we write the field as a linear combination of normalizable and
