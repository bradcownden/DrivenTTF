...
\begin{align}
\overline{T}_\ell &= \frac{1}{2} Z^{-}_{\ell \ob \ob \ell} \left( \frac{\ob}{\ol + \ob} \right) + \frac{1}{2} Z^{+}_{\ell \ob \ob \ell} \left( \frac{\ob}{\ol - \ob} \right) - H_{\ob \ell \ob \ell} \frac{\ol^2}{\ol^2 - \ob^2} + \frac{1}{2} H_{\ell \ob \ob \ell} \left( \frac{2 \ob^2}{\ol^2 - \ob^2} - 1 \right) \nonumber \\
%
& \quad + \ob \ol X_{\ob \ob \ell \ell} \left( \frac{\ob}{\ol -\ob} + \frac{\ob}{\ol + \ob} + \frac{\ol}{\ob} \right) - \ob^2 X_{\ell \ell \ob \ob} \left( \frac{\ob}{\ol - \ob} - \frac{\ob}{\ol + \ob} + 1 \right) \nonumber \\
% 
& \quad + \frac{m^2}{2} V_{\ell \ell \ob \ob} \left( \frac{\ol}{\ol - \ob} + \frac{\ol}{\ol + \ob} + \frac{5}{2} \right) + \frac{m^2}{2} V_{\ob \ob \ell \ell} \left( \frac{\ob}{\ol - \ob} - \frac{\ob}{\ol + \ob} - 1 \right) \nonumber \\
%
& \quad + \ol^2 \tilde{Z}^+_{\ob \ob \ell} - 2 \ob^2 \ol^2 P_{\ell \ell \ob} - \ob^2 M_{\ell \ell \ob} - m^2 \ob^2 Q_{\ell \ell \ob} \, .
\end{align}
...
\begin{align}
S_\ell = \left[ \overline{R}^{(1)}_{(\ell - n) \ell} \Theta \left( \ell - n \right) + \overline{R}^{(2)}_{(\ell + n) \ell }  + \overline{T}_\ell \right]\cos(\thl) \, ,
\end{align}
...
and
\begin{align}
\overline{T}_\ell &= - \frac{3}{4} H_{\ell \ell \ell \ell} + \frac{3}{4} \ol^2 X_{\ell \ell \ell \ell} - \frac{3}{4} m^2 V_{\ell \ell \ell \ell} - 2\ol^4 P_{\ell \ell \ell} - \ol^2 M_{\ell \ell \ell} - m^2 \ol^2 Q_{\ell \ell \ell} \, .
\end{align}
The notation $X_{i12\ell}$ corresponds to evaluating $X_{ijk\ell}$ with $\omega_j = \oone$ and $\omega_k = \otwo$.

\subsubsection{Integer Plus/Minus $\Delta^-$}
...
\oi = 2i + \Delta^- \, .
\end{align}
An examination of the resonance channels shows that the same terms as those found in \S\!~\ref{sec: norm res} appear. The derivation of the resonant terms is therefore trivial, and the solution would only differ by the form of the basis functions {\bf See if source terms still vanish for massless scalars in this case.}
