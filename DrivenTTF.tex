...
\begin{align}
\label{gamma}
\Gamma_{ijk\ell} &= \frac{1}{4} H_{ijk\ell} \frac{\oj (\oi + \ok - 2\oj)}{(\oi - \oj)(\ok - \oj)} + \frac{1}{4} H_{ikj\ell} \frac{\ok (\oi + \oj - 2\ok)}{(\oi - \ok)(\oj - \ok)} + \frac{1}{4} H_{jik\ell} \frac{\oi (\oj + \ok - 2\oi)}{(\oj - \oi)(\ok - \oi)} \nonumber \\
% 
...
\section{Contributions From Non-normalizable Modes}
