...
The non-normalizable modes are the ones that couple to the inhomogeneous part of \eqref{phi1 eqn}. Thus, the general solution for the
scalar field in the bulk, \eqref{general basis}, contains both normalizable \emph{and} non-normalizable components.
...
of the scalar field at the boundary to the expectation value of an operator $\langle \mc O_0 \rangle$.
...
\end{align}
Therefore, the presence of non-normalizable modes corresponds to pumping energy into and out of the system. Finally, 
the Ward identity for time translations gives the time dependence of the 
...
will restrict our work to a set of configurations that will be particularly useful {\bf[CITATION NEEDED].}
