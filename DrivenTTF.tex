...
\begin{align}
S_\ell &= \overline{S}_{i \beta \gamma \ell}\Big|_{\oi + \obet - \ogam = \ol} + \overline{R}_{i \beta} \Big|_{i = \ell} + \overline{T}_\ell
\end{align}
where (sums over the indices that are not $\ell$ are implied, and only restrictions on the indices are explicitly included)
\begin{align}
\overline{S}_{i \beta \gamma \ell} &= \frac{1}{4} \sum_{\gamma \neq \ell} \frac{\ogam}{\oi + \obet} Z^{-}_{i \beta \gamma \ell} + \frac{1}{4} \sum_{\beta \neq \ell} \frac{\obet}{\oi - \ogam} Z^+_{i \gamma \beta \ell} + \sum_{i \neq \ell} \frac{\oi}{\obet - \ogam} Z^+_{\beta \gamma i \ell} + \ldots
\end{align}
\begin{align}
\overline{R}_{i \beta} &= \frac{1}{2} \sum_{\beta \neq \ell} \left[ \frac{\obet}{\ol^2 - \obet^2} \left( (\oi - \obet) Z^{-}_{i \beta \beta \ell} + 2 (\oi + \obet) Z^+_{i\beta \beta \ell} \right) \right] + \ldots
\end{align}
\begin{align}
\overline{T}_\ell &= - \frac{1}{2} \sum \left( 4 \obet^2 \ol^2 P_{\ell \ell \beta} + H_{\beta \beta \ell \ell} + 2\obet^2 M_{\ell \ell \beta} - 2\ol^2 X_{\beta \beta \ell \ell} \right) \cos \theta_\ell \, .
\end{align}
