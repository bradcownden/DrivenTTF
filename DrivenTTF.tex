...
\begin{align}
S_\ell = \overline{T}_{\ob \ell} \, a_\ell A_{\ob}^2 \cos (\thl) \, ,
\end{align}
...
\begin{align}
\label{S:2NN}
\overline{T}_{\ob \ell} &= \left( 1 - \delta(\ol - \ob) \right) \Big\{ \frac{1}{2} Z^-_{\ell\ob\ob\ell} \left( \frac{\ob}{\ol + \ob} \right) + \frac{1}{2} Z^+_{\ell\ob\ob\ell} \left( \frac{\ob}{\ol - \ob} \right)  + H_{\ell \ob \ob \ell} \left( \frac{\ob^2}{\ol^2 - \ob^2} \right) \nonumber \\
%
...
\caption{{\it Left:} Evaluating $\overline{T}_{\ob \ell}$ for a tachyon with $m^2 = -4.0$. {\it Right:} The behaviour of $S_\ell$ near $\omega_0 = \Delta^+ =  2$.}
...
Discuss difference resonances for special cases of $\ob$ beyond the arbitrary value covered in the main portion.
...
\omega_I &= \ol - 2\ob \quad I \in \{i,j,k\} \; \forall \; \ob \in \mathbb{Z}^* \; \text{such that } \ell \geq \ob \\
\omega_I &= 2\ob - \ol \quad I \in \{i,j,k\} \; \forall \; \ob \in \mathbb{Z}^* \; \text{such that } \ell \leq \ob \\
\omega_I &= \ol \; \text{for one of} \; I \in \{i,j,k\}, \; \omega_I = \ob \notin \mathbb{Z}^* \; \text{otherwise}
\end{align}

When $\ob$ is an arbitrary value,
\begin{align}
\overline{T}_\ell &= 2 \left( 1 - \delta(\ol - \ob)\right) \Big\{ X_{\ob \ob \ell \ell} \left( \frac{\ob^2 \ol^2}{\ol^2 - \ob^2} \right) - X_{\ell \ell \ob \ob} \left( \frac{\ob^2 \ol^2}{\ol^2 - \ob^2} \right) -  \ob\ol  X_{\ob\ob\ell\ell} \nonumber \\
%
& \quad + Y_{\ob\ob\ell\ell} \left( \frac{\ol^2}{\ol^2 - \ob^2} \right) - Y_{\ell\ell\ob\ob} \left( \frac{\ob^2}{\ol^2 - \ob^2} \right) + \frac{m^2}{4} V_{\ell \ell \ob \ob} \Big\} \nonumber \\
%
& \quad - \delta(\ol - \ob) \Big\{ \ob^2 X_{\ell\ell\ob\ob} + \ob \ol X_{\ob\ob\ell\ell} + \frac{m^2}{2} V_{\ell\ell\ob\ob} \Big\} + \ob^2 \ol^2 P_{\ob\ob\ell} + \ol^2 B_{\ob \ob \ell} \nonumber \\
%
& \quad -\frac{1}{2} H_{\ob\ob\ell\ell} - \frac{m^2}{2} V_{\ell\ell\ob\ob} - \ol^2 X_{\ob\ob\ell\ell} + 3\ob^2 \ol^2 P_{\ell\ell\ob} -\ob^2 B_{\ell\ell\ob}
\end{align}

When $\ob \in \mathbb{Z}^*  \leq \ell$, resonance is at $\oi = \ol - 2\ob$ with 
\begin{align}
\overline{R}_{i \ell} &= - \frac{1}{12} \left(1 - \delta(\ol - \ob) \right) Z^-_{i \ob \ob \ell} \left(\frac{\ob}{\ol - \ob} \right) \nonumber \\
%
