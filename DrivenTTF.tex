...
\begin{align}
S_\ell &=\frac{1}{4} \sum_{\substack{i,j,k \\ k \neq \ell}}^\infty \frac{a_i a_j a_k \ok}{\ol^2 - \ok^2} \Big[ Z^-_{jk} (\oi + \oj + 2\ok) \cos (\thi + \thj + \thk) - Z^-_{jk} (\oi + \oj - 2\ok) \cos (\thi + \thj - \thk) \nonumber \\
%
&\qquad + Z^+_{jk} (\oi - \oj - 2\ok) \cos (\thi - \thj - \thk) - Z^+_{jk} (\oi - \oj + 2\ok)  \cos(\thi - \thj + \thk) \Big] \nonumber \\
%
...
%
& + \frac{1}{4} \sum_{i,j}^\infty a_i a_j a_\ell \ol \Big[ \tilde Z^-_{ij} (\oi + \oj + 2\ol) \cos(\thi + \thj +  \thl) - \tilde Z^-_{ij} (\oi + \oj - 2\ol) \cos (\thi + \thj - \thl) \nonumber \\
%
& \qquad + \tilde Z^+_{ij} (\oi - \oj - 2\ol) \cos( \thi - \thj - \thl) - \tilde Z^+_{ij} (\oi - \oj + 2\ol) \cos(\thi - \thj + \thl) \Big] \nonumber \\
%
...
\begin{align}
Z^{\pm}_{jk} = \oj \ok \left( X_{k\ell ij} - X_{\ell kij} \right) \pm \left( Y_{ij\ell k} - Y_{ijk\ell} \right) \quad \text{and} \quad \tilde Z^{\pm}_{ij} = \oi \oj P_{ij\ell} \pm B_{ij\ell} \, .
\end{align}

Using integration by parts to remove the derivative from $\nu$ in the definition of $H_{ijk\ell}$, we can show that
\begin{align}
Z_{ijk\ell} = \oi^2 X_{kij\ell} - Y_{\ell kji} + \ok^2 X_{ijk\ell} - Y_{ij\ell k}  - m^2 \left( B_{kij\ell} + B_{ijk\ell} \right) \, .
\end{align}
...
where
\begin{align}
\Omega_{ijk\ell} &= \frac{1}{12} \bigg\{ \oj \ok X_{ijk\ell} \left( \frac{\oi}{\oj + \ok} - \frac{3\ok}{\oi + \oj} - \frac{3\oj}{\oi + \ok} -1 \right) \nonumber \\
%
& \qquad + \oi \ok X_{jki\ell} \left( \frac{\oj}{\oi + \ok} - \frac{3\ok}{\oi + \oj} - \frac{3\oi}{\oj + \ok} - 1 \right) \nonumber \\
%
&\qquad + \oi \oj X_{kij\ell} \left( \frac{\ok}{\oi + \oj} - \frac{3\oi}{\oj + \ok} - \frac{3\oj}{\oi + \ok} -1 \right) \nonumber \\
%
&\qquad - \oi \oj \ok X_{\ell ijk} \left( \frac{1}{\oi + \oj} + \frac{1}{\oj + \ok} + \frac{1}{\oi + \ok} \right) \nonumber \\
%
&\qquad  - Y_{ji\ell k} \left( \frac{\ok}{\oi + \oj} + \frac{\oj}{\oi + \ok} + \frac{\oi}{\oj + \ok} - 3 \right) \nonumber \\
%
&\qquad + \ok Y_{ijk\ell} \left( \frac{1}{\oi + \oj} + \frac{1}{\oj + \ok} + \frac{1}{\oi + \ok} \right) \nonumber \\
% 
& \qquad + \oi Y_{jki\ell} \left( \frac{1}{\oi + \oj} + \frac{1}{\oj + \ok} + \frac{1}{\oi + \ok} \right) \nonumber \\
%
& \qquad + \oj Y_{kij\ell} \left( \frac{1}{\oi + \oj} + \frac{1}{\oj + \ok} + \frac{1}{\oi + \ok} \right) \nonumber \\
%
&\qquad + m^2 \Big[ 2B_{ijk\ell} \left( \frac{\oj}{\oi + \oj} + \frac{\ok}{\oi + \ok} \right) \nonumber \\
%
& \qquad + 2 B_{jki\ell} \left( \frac{\oi}{\oi + \oj} + \frac{\ok}{\oj + \ok} \right) +2 B_{kij\ell} \left( \frac{\oj}{\oj + \ok} + \frac{\oi}{\oi + \ok} \right) \nonumber \\
%
&\qquad  + (B_{ijk\ell} - W_{ijk\ell}) + (B_{jki\ell} - W_{jki\ell}) + (B_{kij\ell} - W_{kij\ell}) \Big] \bigg\} \, .
\end{align}
...
where
\begin{align}
\Gamma_{ijk\ell} &= \frac{1}{4} \bigg\{ m^2 \left(B_{kij\ell} - W_{ijk\ell}\right) + Y_{ij\ell k} - (1+m^2) B_{ijk\ell} \left(\frac{\oj}{\oi - \oj} \right) \nonumber \\
%
& \qquad -3\ok^2 X_{jik\ell} \left( \frac{\oi}{\oi - \oj}\right) + 3 \ok^2 X_{ijk\ell} \left( \frac{\oj}{\oi - \oj} \right) \nonumber \\
%
& \qquad + Y_{\ell kij} \left( \frac{\oi}{\oi - \oj} \right) - Y_{\ell kji} \left( \frac{\oj}{\oi - \oj} \right) \bigg\} \, .
\end{align}
